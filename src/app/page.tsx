      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 pt-24 pb-32 flex flex-col items-center text-center">
        ...
        {!user && (
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <Button variant="outline" size="lg" className="px-12 py-8 rounded-3xl text-lg font-black italic border-white/10 hover:bg-white/5">
        ...
        <div className="mt-24 relative w-full max-w-6xl">
          <div className="absolute inset-0 bg-blue-500/10 blur-[100px] rounded-full scale-75" />
          <div className="relative bg-[#121214] border border-white/5 rounded-[40px] shadow-2xl aspect-[16/10] overflow-hidden p-4">
            <div className="bg-[#1a1a1c] w-full h-full rounded-[32px] border border-white/[0.03] p-12 flex gap-8">
              <div className="w-64 space-y-4">
                {[1, 2, 3, 4, 5].map(i => <div key={i} className={`h-12 rounded-2xl bg-white/[0.0${i + 1}]`} />)}
              </div>
